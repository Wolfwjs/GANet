...
# /data1/hrz/GANet/configs/tusimple/final_exp_res101_s4.py
# CUDA_VISIBLE_DEVICES=1,2,3 GPUS=3 bash tools/dist_train.sh /data1/hrz/GANet/configs/tusimple/final_exp_res101_s4.py
"""
    config file of the large version of GANet for tusimple
"""
# global settings
dataset_type = 'TuSimpleDataset'
data_root = "/data1/hrz/datasets/tusimple"
test_mode = False
