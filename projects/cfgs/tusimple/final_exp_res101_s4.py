from projects.cfgs.tusimple.test_common_s4 import *
from projects.cfgs.tusimple.common import *
...
hm_idx=0
fpn_in_channels = [256, 512, 1024, 2048] # [128, 256, 512]
fpn_out_dim = 64 # diff，都是resnet的第一个layer的结果,256会差一点
attn_out_dim = 256
fpn_attn_idx = -1 # 还是最后的
fpn_down_scale = [4,8,16,32] # diff
sample_gt_points = [81, 41, 21, 11] # 设置gt的数量
sample_per_lane = [81, 41, 21, 11] # 每条lane todo
